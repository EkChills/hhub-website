...
export default function Navbar() {
    return (
        <div className='flex items-center justify-between  pr-4 h-[92px] md:h-[125px]'>
            ...
            <div className=''>
                <svg width="31" height="27" viewBox="0 0 31 27" className='md:hidden' fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='hidden md:flex md:items-center md:gap-6'>
                    {
                        navLinks.map((link, idx) => (
                            <Link key={idx} href={link.link} className='text-[#202020] font-normal hover:text-[#1F5114] transition text-base leading-5.5'>{link.text}</Link>
                        ))
                    }
