            ...
            <MaxWidthWrapper>
                <div className='w-full px-4 bg-white md:rounded-[1.25rem] flex flex-col md:flex-row-reverse md:px-6 py-[42px] md:py-[102px] gap-[50px] lg:gap-[80px] md:gap-[40px]'>
                    <form onSubmit={(e) => {
                        ...
                        mutate()
                    }} className='flex md:w-[60%] flex-col gap-[1.688rem] md:gap-4 '>
                        <div className='flex flex-col md:flex-row gap-[1.688rem] md:gap-8'>
                            ...
                            <InputLabel placeholder='Type your email' label='Email' type='email' ref={emailInputRef} />
                        </div>
                        <InputLabel placeholder='Type your subject' label='Subject' ref={subjectInputRef} />
                        <Textarea required placeholder='Type your message here' ref={messageInputRef} className='min-h-[120px]' />
                        <Button disabled={isPending} className='w-full min-h-[50px] font-bold flex items-center' size={"lg"}>
                            <span>Submit</span>
